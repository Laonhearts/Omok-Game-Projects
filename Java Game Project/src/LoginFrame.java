...
public class LoginFrame extends JFrame {
    ...
    JButton lostidBtn = new JButton("아이디 찾기");
    JButton lostpwBtn = new JButton("비밀번호 찾기");
    ...
    LoginFrame(Client _c) {
        ...
        southPanel.setPreferredSize(new Dimension(330, 110));
        ...
        lostidBtn.setPreferredSize(new Dimension(135, 25));
        lostpwBtn.setPreferredSize(new Dimension(135, 25));
        joinBtn.setPreferredSize(new Dimension(277, 25));
        exitBtn.setPreferredSize(new Dimension(277, 25));
        ...
        /* southPanel 컴포넌트 */
        southPanel.add(lostidBtn);
        southPanel.add(lostpwBtn);
        ...
        lostidBtn.addActionListener(bl);
        lostpwBtn.addActionListener(bl);
    ...
    class ButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            else if(b.getText().equals("아이디 찾기")) {
                System.out.println("[Client] 아이디 찾기");
                c.idf.setVisible(true);
            }

            else if(b.getText().equals("비밀번호 찾기")) {
                System.out.println("[Client] 비밀번호 찾기");
                c.pf.setVisible(true);
            }
